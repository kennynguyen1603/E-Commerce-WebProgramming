        ...
        <form method="POST" action="/E-Commerce/app/server/signup_handler.php">
            <div class="form-group">
                ...
                <div class="input-container">
                    <input type="text" name="first_name" placeholder="Enter your first name" class="input-field">
                </div>
            </div>
            <div class="form-group">
                <label for="last_name">Last Name</label>
                <div class="input-container">
                    <input type="text" name="last_name" placeholder="Enter your last name" class="input-field">
                </div>
            </div>
            <div class="form-group">
